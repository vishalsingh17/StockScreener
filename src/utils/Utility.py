...
from utils.Changelog import VERSION, changelog
...
class tools:
    ...
    def showDevInfo():
        ...
        print(colorText.BOLD + colorText.WARN +
              "\n[+] Developer: Vishal Singh." + colorText.END)
        print(colorText.BOLD + colorText.WARN +
              ("[+] Version: %s" % VERSION) + colorText.END)
        print(colorText.BOLD +
              "[+] Home Page: https://github.com/vishalsingh17/StockScreener" + colorText.END)
        print(colorText.BOLD + colorText.FAIL +
              "[+] Read/Post Issues here: https://github.com/vishalsingh17/StockScreener/issues" + colorText.END)
        print(colorText.BOLD + colorText.GREEN +
              "[+] Join Community Discussions: https://github.com/vishalsingh17/StockScreenerdiscussions" + colorText.END)
        print(colorText.BOLD + colorText.BLUE +
              "[+] Download latest software from https://github.com/vishalsingh17/StockScreenerreleases/latest" + colorText.END)
        input('')
    ...
    def loadStockData(stockDict, configManager, proxyServer=None):
        ...
        if os.path.exists(cache_file):
            ...
            cache_url = "https://raw.github.com/vishalsingh17/StockScreener/data/data/" + cache_file
...
[+] Select option: """ + colorText.END))
    ...
    def getNiftyModel(proxyServer=None):
        ...
        urls = [
            f"https://raw.github.com/vishalsingh17/StockScreener/main/src/ml/{files[0]}",
            f"https://raw.github.com/vishalsingh17/StockScreener/main/src/ml/{files[1]}"
        ]
